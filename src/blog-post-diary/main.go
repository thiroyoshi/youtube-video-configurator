...
func generatePostByPosts(posts string, now time.Time) (string, string) {
...
// BlogPostDiary is an HTTP Cloud Function.
func blogPostDiary(w http.ResponseWriter, r *http.Request) {
...
func init() {
	functions.HTTP("BlogPostDiary", blogPostDiary)
}
