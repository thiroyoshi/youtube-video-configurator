resource "google_pubsub_topic" "blog_post_diary_schedule_topic" {
  name = "blog-post-diary-schedule-topic"
}
...
resource "google_pubsub_topic_iam_member" "function_subscriber" {
  topic  = google_pubsub_topic.blog_post_diary_schedule_topic.name
